...
class EmailService {
  ...
  async sendVerificationEmail(email, name, token) {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Verify Your Email - PartyTix',
  ...
  async sendPasswordResetEmail(email, name, token) {
    ...
    const mailOptions = {
      from: `"PartyTix" <${process.env.SMTP_USER}>`,
      to: email,
      subject: 'Reset Your Password - PartyTix',
  ...
  getVerificationEmailTemplate(name, verificationUrl) {
    return `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>🎉 Welcome to PartyTix!</h1>
          </div>
          <div class="content">
            <h2>Hello ${name}!</h2>
            <p>Thank you for registering with PartyTix! To ensure your account security, please verify your email address.</p>
            ...
            <div class="warning">
              ...
              <ul>
                ...
                <li>Unverified accounts cannot purchase tickets, create events, or withdraw funds</li>
            ...
            <p>If you didn't register for a PartyTix account, please ignore this email.</p>
          </div>
          <div class="footer">
            <p>This email was sent automatically by PartyTix system. Please do not reply.</p>
...
Thank you for registering with PartyTix! To ensure your account security, please verify your email address.
...
- Unverified accounts cannot purchase tickets, create events, or withdraw funds
- If you didn't register for a PartyTix account, please ignore this email

This email was sent automatically by PartyTix system. Please do not reply.
