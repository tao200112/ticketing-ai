...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS merchant_email TEXT;
...
ALTER TABLE tickets ADD COLUMN IF NOT EXISTS merchant_id UUID REFERENCES merchants(id) ON DELETE SET NULL;
ALTER TABLE tickets ADD COLUMN IF NOT EXISTS merchant_email TEXT;
...
DO $$
BEGIN
    RAISE NOTICE 'PartyTix Updated Schema migration completed successfully!';
    ...
    RAISE NOTICE 'Seed data inserted: Ridiculous Chicken merchant and test invite code';
    RAISE NOTICE 'Schema is ready for use!';
    RAISE NOTICE 'Test invite code: INV_MH59SBGD_D20Z7C';
END $$;
